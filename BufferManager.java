...
public interface BufferManager {
     ...
     * @throws BufferManagerException if pid is not in the cache and it cannot be read from disk
     * (e.g. if the buffer pool is full and cannot find a page to evict).
     * @return Page object
     */
